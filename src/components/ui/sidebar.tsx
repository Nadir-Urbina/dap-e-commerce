                ...
                <div className="px-4">
                  <div className="space-y-1">
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex items-center gap-3 rounded-lg px-3 py-2 text-gray-300 transition-all hover:text-[#EFCD00]",
                        pathname.startsWith("/dashboard/products") && "bg-[#EFCD00]/10 font-medium text-[#EFCD00]"
                      )}
                    >
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex items-center gap-3 rounded-lg px-3 py-2 text-gray-300 transition-all hover:text-[#EFCD00]",
                        pathname.startsWith("/dashboard/invoices") && "bg-[#EFCD00]/10 font-medium text-[#EFCD00]"
                      )}
                    >
